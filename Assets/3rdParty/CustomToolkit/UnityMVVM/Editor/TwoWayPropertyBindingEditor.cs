    ...
    class TwoWayPropertyBindingEditor : BaseBindingEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ShowViewPropertyMenu(
                ...
                MVVMHelper.FindBindableViewProperties(targetScript.gameObject)
            ...
            var viewAdapterTypeNames = GetAdapterTypeNames(
                type => viewPropertyType == null ||
                    MVVMHelper.FindAdapterAttribute(type).OutputType == viewPropertyType
            );
            ...
            ShowViewModelPropertyMenu(
                ...
                MVVMHelper.FindBindableViewModelProperties(targetScript).ToArray(),
            ...
            var viewModelAdapterTypeNames = GetAdapterTypeNames(
                type => adaptedViewPropertyType == null ||
                    MVVMHelper.FindAdapterAttribute(type).OutputType == adaptedViewPropertyType
            );
            ...
            var expectionAdapterTypeNames = GetAdapterTypeNames(
                type => MVVMHelper.FindAdapterAttribute(type).InputType == typeof(Exception)
            );
